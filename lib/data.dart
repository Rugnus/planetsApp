...
List<PlanetInfo> planets = [
  PlanetInfo(1,
      name: 'Mercury',
      iconImage: 'asset/images/mercury.png',
      description:
  ...
  PlanetInfo(2,
      name: 'Venus',
      iconImage: 'asset/images/venus.png',
      description:
  ...
  PlanetInfo(3,
      name: 'Earth',
      iconImage: 'asset/images/earth.png',
      description:
  ...
  PlanetInfo(4,
      name: 'Mars',
      iconImage: 'asset/images/mars.png',
      description:
  ...
  PlanetInfo(5,
      name: 'Jupiter',
      iconImage: 'asset/images/jupiter.png',
      description:
  ...
  PlanetInfo(6,
      name: 'Saturn',
      iconImage: 'asset/images/saturn.png',
      description:
  ...
  PlanetInfo(7,
      name: 'Uranus',
      iconImage: 'asset/images/uranus.png',
      description:
  ...
  PlanetInfo(8,
      name: 'Neptune',
      iconImage: 'asset/images/neptune.png',
      description:
